...
const downloadFromInfoCallback = (stream, info, options) => {
  ...
  utils.setPropInsensitive(options.requestOptions.headers, "Referer", "https://www.youtube.com");
  utils.setPropInsensitive(options.requestOptions.headers, "Origin", "https://www.youtube.com");
