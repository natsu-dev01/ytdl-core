...
exports.getInfo = async (id, options) => {
  ...
  info.html5player = info.html5player.replace('player_ias.vflset', 'player_es6.vflset');
...
const WEB_EMBEDDED_CONTEXT = {
  client: {
    ...
    clientVersion: "1.20260628.05.00",
    ...LOCALE,
  },
};
...
const TVHTML5_CONTEXT = {
  client: {
    clientName: "TVHTML5",
    clientVersion: "7.20260628.05.00",
    ...LOCALE,
  },
};
...
const IOS_CLIENT_VERSION = "19.45.4",
  IOS_DEVICE_MODEL = "iPhone17,3",
  IOS_USER_AGENT_VERSION = "18_0",
  IOS_OS_VERSION = "18.0.22A5282m";
